...
public interface DemoResources extends ClientBundle
{
	...
	@Source("images/example_buffer_geometry.jpg")
	ImageResource exampleBufferGeometry();
	
	@Source("images/example_buffer_geometry_particles.jpg")
	ImageResource exampleBufferGeometryParticles();
	...
	@Source("images/example_normals.jpg")
	ImageResource exampleGeometryNormals();
	...
	@Source("images/example_materials_texture_compressed.jpg")
	ImageResource exampleMaterialsTextureCompressed();
	...
	@Source("images/example_rtt.jpg")
	ImageResource exampleMaterialsRtt();
