...
import thothbot.squirrel.lib.client.shader.Uniform;
...
import thothbot.squirrel.lib.shared.core.WebGLCustomAttribute;
import thothbot.squirrel.lib.shared.materials.Material;
import thothbot.squirrel.lib.shared.materials.ShaderMaterial;
...
public class CustomAttributesParticles extends ContentWidget
{
	...
	{
		return Demo.resources.example_custom_attributes_particles();
	}
